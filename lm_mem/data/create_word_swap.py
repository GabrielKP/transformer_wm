...
from lm_mem.data.nonce import get_nouns, get_verbs
from lm_mem.data.sentences import (
    SUBJECT_MARKER,
    VERB_MARKER,
    get_sentence_combinations_revised_resampled,
    load_synonyms_revised_resampled,
)
from lm_mem.data.utils import compute_hash, read_vignettes, save_with_suffix
